...
let formMateria : Formulario
let materia : Materia | undefined
let listaMAterias : Curso[][] = []
...
add_materia?.addEventListener("click", agregarMateria)
...
function iniciarLogica(){
    ...
    let manejador : Handler = new Handler(listaMAterias)
    manejador.iniciar()
}
comenzar?.addEventListener("click", iniciarLogica)
/*
